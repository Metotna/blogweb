...
<div class='datapack'>
  <div class="d_body" v-if='show'>
    ...
    <el-date-picker v-model="value[0]" :type="types" placeholder="开始日期" :size='sizes' :style='stylewidth' :picker-options="picker1" :default-value="new Date()" @change='valChange' :clearable='clearable'></el-date-picker>
